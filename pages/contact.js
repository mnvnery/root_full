                ...
                <TwoColLayout cols='grid-cols-[0.3fr_0.7fr]' border='border-t border-white mb-14'>
                    ...
                    <div className='pt-10'>
                      <div className='border-b border-white'>
                        <div dangerouslySetInnerHTML={{__html: data.contactIntro}} className='paragraph md:text-3xl md:w-2/4 mb-10 ml-8 xxl:ml-14'/>
                      </div>
                      <div className='flex ml-8 xxl:ml-14 space-x-20 md:text-3xl py-10'>
                      ...
                      <div className='ml-8 xxl:ml-14 md:text-3xl'>
