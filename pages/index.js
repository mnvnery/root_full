    ...
    <div className='min-h-screen text-lg md:text-base xxl:text-3xl flex flex-col items-center md:justify-between py-10 md:px-10'>
      <div className='flex flex-col items-center md:flex-row md:justify-between w-full'>
        <div className='space-x-8 hidden md:flex'>
          ...
          <a href='https://twitter.com/wearerootmedia' target='_blank' className='underline'>TWITTER</a>
          <a href='https://www.linkedin.com/company/root-media/' target='_blank' className='underline'>LINKEDIN</a>
        </div>
      ...
      <Image src={'/root_gif.gif'} objectFit='contain' layout='fill'/>
      </div>
